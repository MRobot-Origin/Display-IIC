namespace MRobot {
    ...
    //% blockId="OLED_12864_I2C_PIXEL" block="设置像素点在|x%x y%y 颜色%color"
    //% weight=70 blockGap=8
    //% parts=OLED_12864_I2C trackArgs=0
     ...
     */
    //% subcategory="oled12864"
    //% blockId="OLED_12864_I2C_SHOWSTRING" block="显示字符串在|x%x y%y 文本 %s|颜色 %color"
     ...
     */
    //% subcategory="oled12864"
    //% blockId="OLED_12864_I2C_NUMBER" block="显示数字在|x %x y %y|数字 %num|颜色 %color"
    //% weight=80 blockGap=8
    //% parts=OLED_12864_I2C trackArgs=0
     ...
     */
    //% subcategory="oled12864"
    //% blockId="OLED_12864_I2C_HLINE" block="划一条横线在|x %x y %y|长度 %len|颜色 %color"
     ...
     */
    //% subcategory="oled12864"
    //% blockId="OLED_12864_I2C_VLINE" block="画一条垂直线|x %x y %y|长度 %len|颜色 %color"
     ...
     */
    //% subcategory="oled12864"
    //% blockId="OLED_12864_I2C_RECT" block="画一个矩形框|x1 %x1 y1 %y1|x2 %x2 y2 %y2|颜色 %color"
     ...
     */
    //% subcategory="oled12864"
    //% blockId="OLED_12864_I2C_INVERT" block="反转显示 %d"
     ...
     */
    //% subcategory="oled12864"
    //% blockId="OLED_12864_I2C_DRAW" block="重绘"
     ...
     */
    //% subcategory="oled12864"
    //% blockId="OLED_12864_I2C_CLEAR" block="清屏"
     ...
     */
    //% subcategory="oled12864"
    //% blockId="OLED_12864_I2C_ON" block="打开OLED12864"
     ...
     */
    //% subcategory="oled12864"
    //% blockId="OLED12864_I2C_OFF" block="关闭OLED12864"
     ...
     */
    //% subcategory="oled12864"
    //% blockId="OLED_12864_I2C_ZOOM" block="缩放 %d"
     ...
     */
    //% subcategory="oled12864"
    //% blockId="OLED_12864_I2C_init" block="初始化 OLED的IIC地址为 %addr"
